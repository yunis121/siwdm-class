...
/* SIWDM */
enum ncdmtca_flags {ncdmtca_on, ncdmtca_off}; // Flag that determines if SIWDM TCA is on
//enum ncdmnrsd_flags {ncdmnrsd_rel, ncdmnrsd_nrel};
...
enum ncdmtca_method {ncdmtca_mb, ncdmtca_none};
...
struct perturb_workspace
{
  ...
  */
  ...
  int index_ap_ncdmtca_ncdm1; /**< index for SIWDM tight coupling approximation, for the first species  */
